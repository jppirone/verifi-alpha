...
(() => {
  ...
  const acct = (n, s) => {
    ...
    out.push(`insert into certification_items (id,candidate_id,name,issuing_body,license_number,candidate_confirmed) values (${q(cert)},${q(cid)},${q(s.certName || 'Certified General Contractor')},'State of Florida (DBPR)',${q(s.number)},true);`);

...
// step inside reconstructByWordClustering — every downstream consumer inherits the same corrected
// text, rather than each extraction prompt needing its own patch. Mirrored from rasterize-pdf-
// page/index.ts's own copy of this same function and comment (this file's own OCR path — the
// image-upload path — is otherwise independent of that one).
//
